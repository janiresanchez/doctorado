...
- **Nombre:** Janire Sánchez
- **Situación actual:** **Pre-doctorado.** Definiendo la pregunta de
  investigación para proponerla a la Cátedra UNESCO de Educación Ambiental y
  Desarrollo Sostenible (UNED). Sin matrícula formalizada.
- **Objetivo inmediato:** presentar una propuesta de tesis defendible a
  María José Bautista-Cerro, directora de la Cátedra.
...
- **Máster en Gestión del Turismo Sostenible y Ecológico** — Universidad
  ...
  - **Derivó en un primer artículo científico publicado.** <!-- Falta la
    referencia completa: revista, año, coautores, DOI. Es el primer mérito del CV. -->

## Trayectoria profesional

- **CEA Caserío de Henares** — Centro de Educación Ambiental, Comunidad de Madrid.
- **CEA Polvoranca** — Centro de Educación Ambiental, Comunidad de Madrid.
- **Fundación Renovables** *(actual)* — Responsable de Educación y
  Sensibilización. ONG del tejido ecologista.
  - Divulgación (vídeo y otros recursos) e impartición de talleres en centros
    educativos.
...
Diseña e imparte sus propios talleres en centros educativos. **No depende de
terceros para acceder al campo:** su dispositivo de intervención profesional
puede funcionar como instrumento de investigación. Esto es lo que hace viable
...
|---|---|---|
| Madrid | Residencia y trabajo | Base actual; posible caso urbano de contraste |
| Segovia (rural) | Fines de semana; quiere trasladarse | Campo prioritario |
| La Rioja | Origen; acceso fácil | Campo secundario |

Arraigo rural real: creció en el medio rural y conoce de primera mano el
funcionamiento de un CRA (Colegio Rural Agrupado). **No tiene experiencia
profesional en el medio rural**, es vínculo personal y biográfico.

## Restricciones prácticas

- **El doctorado convivirá con un trabajo a jornada completa** en Fundación
  Renovables. Cualquier plan de campo debe ser compatible con eso.
- El acceso al campo depende de que Fundación Renovables lleve talleres a
  Segovia y La Rioja: hay que confirmar que la organización lo respalda.
